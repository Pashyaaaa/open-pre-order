  ...
  if(cart.length !== 0) {
    return (
      <>
        ...
        <Link to={'/form-data-user'} className="w-full mt-5 block button text-center" name="Konfirmasi" aria-label="Konfirmasi Pesananan">Konfirmasi Pesanan</Link>
        <button className="w-full focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-base px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800" name="Konfirmasi" aria-label="Konfirmasi Pesananan" onClick={() => {
          navigate(-1)
          setCart([])
